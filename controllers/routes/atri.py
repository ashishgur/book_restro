...
class Atri:
	def __init__(self, state: Any):
		...
		self.background_felx = state["background_felx"]
	...
	@property
	def background_felx(self):
		self._getter_access_tracker["background_felx"] = {}
		return self._background_felx
	@background_felx.setter
	def background_felx(self, new_state):
		self._setter_access_tracker["background_felx"] = {}
		global default_state
		self._background_felx = Flex(new_state, default_state["background_felx"])
	...
	def _to_json_fields(self):
		return {
			"background_felx": self._background_felx,
			"Flex2": self._Flex2,
			"Flex3": self._Flex3,
			"Flex4": self._Flex4,
			"Flex5": self._Flex5,
