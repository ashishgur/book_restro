...
class Atri:
	...
	@property
	def BACKGROUND_FLEX(self):
		self._getter_access_tracker["BACKGROUND_FLEX"] = {}
		return self._BACKGROUND_FLEX
	@BACKGROUND_FLEX.setter
	def BACKGROUND_FLEX(self, new_state):
		self._setter_access_tracker["BACKGROUND_FLEX"] = {}
		global default_state
		self._BACKGROUND_FLEX = Flex(new_state, default_state["BACKGROUND_FLEX"])
	...
	def Dropdown2(self, new_state):
		...
		global default_state
		self._Dropdown2 = Dropdown(new_state, default_state["Dropdown2"])
	...
	def _to_json_fields(self):
		return {
			"BACKGROUND_FLEX": self._BACKGROUND_FLEX,
			"Flex8": self._Flex8,
			"Flex9": self._Flex9,
			"Flex10": self._Flex10,
			"Flex11": self._Flex11,
