...
class Atri:
	def __init__(self, state: Any):
		...
		self.BACKDROUND_FELX = state["BACKDROUND_FELX"]
	...
	@property
	def BACKDROUND_FELX(self):
		self._getter_access_tracker["BACKDROUND_FELX"] = {}
		return self._BACKDROUND_FELX
	@BACKDROUND_FELX.setter
	def BACKDROUND_FELX(self, new_state):
		self._setter_access_tracker["BACKDROUND_FELX"] = {}
		global default_state
		self._BACKDROUND_FELX = Flex(new_state, default_state["BACKDROUND_FELX"])
	...
	def _to_json_fields(self):
		return {
			"BACKDROUND_FELX": self._BACKDROUND_FELX,
			"Flex13": self._Flex13,
			"Flex14": self._Flex14,
			"Flex15": self._Flex15,
			"Image1": self._Image1,
